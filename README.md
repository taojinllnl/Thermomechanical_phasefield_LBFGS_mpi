...
For example, if the executable is launched from the project root directory, `project_root`, then, `set Config dir = ./path/to/config_dir`, the directory path will be referred to `<project_root>/path/to/config_dir`. 
